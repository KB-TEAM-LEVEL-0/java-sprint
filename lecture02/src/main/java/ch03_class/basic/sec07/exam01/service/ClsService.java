...
//import main.java.ch03_class.basic.sec07.exam01.vo.TestVO;
...
//        System.out.println(std.v4);
        ...
        System.out.println("상속 관계"); // extends 추가
...
//        std1.name = "홍길동"; // 직접 접근
        ...
        // ** static 이 붙은 필드(변수)는 클래스명.변수명으로 작성!
...
//        System.out.println(Student.schoolName);
        ...
        System.out.println("std3의 학교 : " + std3.schoolName); // KB 유치원
    }
